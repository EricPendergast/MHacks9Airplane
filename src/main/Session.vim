...
silent only
cd ~/Documents/programming/hackathon/src/main
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +21 Start.java
badd +12 ~/Documents/programming/hackathon/src/states/Game.java
badd +1 ~/Documents/programming/hackathon/src/input/Mouse.java
badd +0 ~/Documents/programming/hackathon/src/input/MouseWheel.java
argglobal
silent! argdel *
argadd Start.java
set stal=2
...
19
normal! zo
let s:l = 21 - ((16 * winheight(0) + 19) / 38)
...
exe 'vert 1resize ' . ((&columns * 31 + 72) / 144)
exe 'vert 2resize ' . ((&columns * 112 + 72) / 144)
tabedit ~/Documents/programming/hackathon/src/input/Mouse.java
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
